...
const Navbar = () => {
  ...
  return (
    <nav
      className={cn(
        'border-b border-dashed fixed inset-x-0 transition-all duration-300 border-neutral-400 bg-white/30 dark:bg-black/50 !backdrop-blur-md z-40',
        isScrolled &&
          'shadow-md dark:shadow-black border-solid border-neutral-300 dark:border-neutral-700 !backdrop-blur-md'
      )}>
