...
const HeroSection = () => {
  return (
    <section className='relative' id='about-section'>
      ...
      <div className='section flex flex-row justify-between items-center gap-10'>
        ...
        <div className='relative'>
          <div className='pointer-events-none absolute w-full bg-gradient-to-r from-transparent via-transparent to-white dark:to-[#070707] z-10 h-full' />
          <pre className='hidden dark:block pointer-events-none absolute w-full h-full z-[1] bg-[linear-gradient(330deg,rgba(0,0,0,0)_0%,rgba(0,0,0,0)_20%,rgba(255,255,255,1)_20%,rgba(255,255,255,1)_45%,rgba(255,255,255,1)_45%,rgba(255,255,255,1)_55%,rgba(255,255,255,1)_55%,rgba(255,255,255,1)_80%,rgba(0,0,0,0)_80%)]' />
