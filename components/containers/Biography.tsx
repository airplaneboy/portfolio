...
const Biography = () => {
  return (
    <section
      ...
      className='min-h-screen py-[57px] flex flex-col dark:bg-grid-small-white/[0.1] bg-grid-small-black/[0.1] relative border-t border-dashed border-neutral-500 shadow-inner dark:shadow-black'>
