...
const SkillsPage = () => {
  ...
  return (
    <div className='dark:bg-transparent bg-neutral-950'>
       <section
      id='skills-section'
      className='min-h-screen pt-[57px] flex flex-col dark:bg-grid-small-white/[0.1] bg-grid-small-white/[0.2] relative border-t border-dashed border-neutral-500 shadow-inner dark:shadow-black'>
