...
an aspiring computer science student with a broad background in tech. My journey has taken me through various fields, including web development, game development, and 3D animation, alongside my current role serving in the Army Reserves as a CBRN (Chemical, Biological, Radiological, and Nuclear) specialist. I’ve also earned an OSHA 10-Hour General Industry certification to prioritize safety and professionalism in any environment.
